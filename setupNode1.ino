...
void setup()
{
  ...
  configuration.SPED.airDataRate = AIR_DATA_RATE_010_24; // tốc độ k dây,càng thaaso -> khoảng cách lớn, chống nhiễu tốt hơn, tgian dài hơn.phải cùng nhau ở 2 thiết bị
